        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              GestureDetector(
                  onTap: () {
                    _pagecount.animateTo(size.width,
                        duration: Duration(milliseconds: 400),
                        curve: Curves.linear);
                    setState(() {
                      choice = "ilanlar";
...
class shadowProfileBox extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    myPath.quadraticBezierTo(firststartpoint.dx, firststartpoint.dy,
        firstendpoint.dx, firstendpoint.dy);
    myPath.quadraticBezierTo(secondstartpoint.dx, secondstartpoint.dy,
        secondendpoint.dx, secondendpoint.dy);
    myPath.quadraticBezierTo(
        editstartpoint.dx, editstartpoint.dy, editendpoint.dx, editendpoint.dy);
    myPath.quadraticBezierTo(thirdstartpoint.dx, thirdstartpoint.dy,
        thirdendpoint.dx, thirdendpoint.dy);
    myPath.quadraticBezierTo(fourthstartpoint.dx, fourthstartpoint.dy,
