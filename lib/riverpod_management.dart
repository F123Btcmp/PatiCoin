...
import 'package:streetanimals/Riverpod/post_provider.dart';
import 'package:streetanimals/Riverpod/refresh_provider.dart';
...
final refreshRiverpod = ChangeNotifierProvider((ref) => refreshProvider());
final postRiverpod = ChangeNotifierProvider((ref) => postProvider());